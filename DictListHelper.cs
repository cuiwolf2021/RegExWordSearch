...
{
    public static class DictListHelper
    {
        #region Dict相关
        /// <summary>
        ...
        private static readonly string Sql4CreatelDictsInfo = $@"CREATE TABLE [{_Dicts_Info_Table}](  [{
        ...
        public static int SetupDictsInfo(List<DictInfo> toOpDictInfos, DictOps dictOp, SqliteSingleton sqliteInstance)
        {
            ...
            sqliteInstance.WriteTable2Db(dt, _Dicts_Info_Table, Sql4CreatelDictsInfo);
            return resultCount;
        }
